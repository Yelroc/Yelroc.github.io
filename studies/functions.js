...
* FUNCTIONS
*
* Functions are a set of statements that perform an action. To use a function you must define it
* in the scope you are calling it in.
*/
...
nolaGreeter('chris'); // When calling a function you must replace the parameter, with an argument. 
...
/* Closures are a function with access to the parent scope even after the parent function has closed.
*/
...
/* Scope = Imagine your code in nested boxes
*
* Global--- Functions--- If/Else --- LOOPS ARE A YES n NO
* 
* Scopes determine what we have access to
*
* Global scopes are global scopes
* Functions scopes are local scopes
* If/Else scopes are block scopes
* Loop scopes are block scopes
*/